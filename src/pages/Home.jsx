...
const Home = ({ scrollToSection }) => {
    ...
    return (
        <section id="home" className="section bg-[#0b0b17] min-h-screen flex items-center pt-20 pb-10" data-scroll-section>
                ...
                <div className="flex flex-col md:flex-row items-center">
                    ...
                    <motion.div className="md:w-1/2 mb-10 md:mb-0"
                        ...
                        <div className="mt-12 flex items-center space-x-4">
                            ...
                            <a href="https://github.com/KFS-developer" className="social-icon text-gray-400 hover:text-white"><FaGithub className="text-xl" /></a>
                            <a href="https://www.linkedin.com/in/patel-ketul-0654b0266/" className="social-icon text-gray-400 hover:text-white"><FaLinkedinIn className="text-xl" /></a>
                        </div>
                    </motion.div>

                    <motion.div className="md:w-1/2 mt-12 md:mt-0 flex justify-center relative"
